...
class TodosIncompleteScreen extends StatelessWidget {
  Todo todo;
  @override
  Widget build(BuildContext context) {
    BlocProvider.of<TodoIncomplete>(context).fetchTodosIncomplete();

    return Scaffold(
        body: BlocBuilder<TodoIncomplete, TodoIncompleteState>(
